...
export default function AddressForm({
  ...
  return (
    <ScrollArea className="h-[80vh] md:h-fit">
      <div className="space-y-6 mt-6">
        ...
        <Form {...form}>
          <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col md:flex-row items-center gap-3 md:gap-6 mt-8">
              <Button
                type="button"
                size="lg"
                disabled={isPending}
                onClick={onClose}
                className="bg-[#E2FAEC] w-full md:w-fit text-primary shadow-none hover:bg-[#E2FAEC]/80 hover:text-primary/80 px-12"
              >
                Go Back
              </Button>
              ...
              <Button
                ...
                onClick={() => form.reset()}
                variant="destructive"
                className="bg-[#E74C3C33] w-full md:w-fit text-destructive shadow-none hover:bg-[#E74C3C33] hover:text-destructive/80 px-8"
              >
                Clear All
              </Button>
